      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('Email: ${cliente.email}', style: const TextStyle(fontSize: 16)),
              const SizedBox(height: 12),
              Text('Grupo: ${cliente.grupo}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              const Divider(height: 30),
              const Text('Histórico de Compras:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
