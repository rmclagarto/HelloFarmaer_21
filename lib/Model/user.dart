...
class Utilizador {
  ...
  //         : [],
  //     minhasLojas: json['minhasLojas'] is List
  //         ? List<String>.from(json['minhasLojas'])
  //         : [],
  //     meusProdutosFavoritos: json['meusProdutosFavoritos'] is List
  ...
  Utilizador copyWith({
    ...
    return Utilizador(
      ...
      meusProdutosFavoritos: meusProdutosFavoritos ?? this.meusProdutosFavoritos,
